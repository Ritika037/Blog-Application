...
<html lang="en">
  ...
  <head>
    ...
    <title>MANIT Blog Project</title>
                ...
                <div class="col-lg-12">
                  <div class="blog-post">
                    <div class="blog-thumb">
                        <center>  <img src="<%=blog.getPoster()%>" alt="" style="width:80%;height:300px;border-width:1px;border-style: double;border-radius: 10px;"></center>
                    </div>
